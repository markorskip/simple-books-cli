...
public class SimpleBooksCliApplication {
	 ...
	 * 
	 * How is better than a spreadsheet?
	 ...
	 * -Less user error
	 * 
	 * How is better than a paid online bookkeeping service?
	 ...
	 *  
	 *  How is it worse than a spreadsheet?
	 *  -A spreadsheet you track whatever you want, however you want.  This software enforces 
	 *  a pattern. It may not suit your business.
	 *  
	 *  How is it worse than an online bookkeepign service?
	 *  Online bookkeeping services are better for users who require a web app (point and click experience).
	 *  
